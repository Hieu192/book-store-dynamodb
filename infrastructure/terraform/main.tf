# AWS Fargate Infrastructure with Terraform
...
# NAT Gateway (chỉ 1 để tiết kiệm chi phí)
...
# Application Load Balancer (Public - chỉ CloudFront access)
resource "aws_lb" "main" {
  name               = "${var.project_name}-alb"
  internal           = false  # Public ALB (nhưng chỉ CloudFront access)
...
# Listener Rules
# WebSocket rule (higher priority)
...
# IAM Policy for ECS Task (DynamoDB, S3, etc.)
